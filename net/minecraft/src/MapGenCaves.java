...
public class MapGenCaves extends MapGenBase
{
            ...
            int k, int i1, double d3)
    {
        ...
        for(; k < i1; k++)
        {
            ...
            if(k2 > worldObj.worldHeight - 8)
            {
                k2 = worldObj.worldHeight - 8;
            }
            if(l2 < 0)
            {
                l2 = 0;
            ...
            for(int j3 = l1; !flag2 && j3 < i2; j3++)
            {
                for(int l3 = l2; !flag2 && l3 < i3; l3++)
                {
                    ...
                    {
                        int j4 = (j3 * 16 + l3) * worldObj.worldHeight + i4;
                        if(i4 < 0 || i4 >= worldObj.worldHeight)
                        {
                            continue;
                        }
...
label0:
                for(int k4 = l2; k4 < i3; k4++)
                {
                    ...
                    int l4 = (k3 * 16 + k4) * worldObj.worldHeight + k2;
                    boolean flag3 = false;
                        ...
                        if(d14 > -0.69999999999999996D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D)
                        {
                            ...
                            if(byte0 == Block.stone.blockID || byte0 == Block.dirt.blockID || byte0 == Block.grass.blockID)
                            {
                                ...
                                } else
                                {
                                    ...
                                    {
                                        abyte0[l4 - 1] = worldObj.getWorldChunkManager().getBiomeGenAt(k3 + i * 16, k4 + j * 16).topBlock;
                                    }
                                }
                            }
                        }
