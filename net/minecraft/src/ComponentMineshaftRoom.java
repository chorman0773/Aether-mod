...
public class ComponentMineshaftRoom extends StructureComponent
{
    ...
    public void buildComponent(StructureComponent structurecomponent, List list, Random random)
    {
        ...
        for(int k = 0; k < boundingBox.getXSize(); k += 4)
        {
            ...
            StructureComponent structurecomponent1 = StructureMineshaftPieces.getNextComponent(structurecomponent, list, random, boundingBox.minX + k, boundingBox.minY + random.nextInt(j) + 1, boundingBox.minZ - 1, 2, i);
        ...
        for(int l = 0; l < boundingBox.getXSize(); l += 4)
        {
            l += random.nextInt(boundingBox.getXSize());
            if(l + 3 > boundingBox.getXSize())
            {
                break;
            }
            StructureComponent structurecomponent2 = StructureMineshaftPieces.getNextComponent(structurecomponent, list, random, boundingBox.minX + l, boundingBox.minY + random.nextInt(j) + 1, boundingBox.maxZ + 1, 0, i);
        ...
        for(int i1 = 0; i1 < boundingBox.getZSize(); i1 += 4)
        {
            ...
            StructureComponent structurecomponent3 = StructureMineshaftPieces.getNextComponent(structurecomponent, list, random, boundingBox.minX - 1, boundingBox.minY + random.nextInt(j) + 1, boundingBox.minZ + i1, 1, i);
        ...
        for(int j1 = 0; j1 < boundingBox.getZSize(); j1 += 4)
        {
            j1 += random.nextInt(boundingBox.getZSize());
            if(j1 + 3 > boundingBox.getZSize())
            {
                break;
            }
            StructureComponent structurecomponent4 = StructureMineshaftPieces.getNextComponent(structurecomponent, list, random, boundingBox.maxX + 1, boundingBox.minY + random.nextInt(j) + 1, boundingBox.minZ + j1, 3, i);
