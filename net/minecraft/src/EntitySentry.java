...
//            DamageSource, EntityLiving, EntityPlayer, AetherBlocks, 
//            Block
...
public class EntitySentry extends EntityDungeonMob
{
    ...
    public void onUpdate()
    {
        ...
        if(!onGround && flag && entityToAttack != null)
        {
            motionX *= 3D;
            motionZ *= 3D;
        }
    ...
    {
        if(!isDead && entityToAttack != null && entity != null && entityToAttack == entity)
        {
    ...
    protected void updateEntityActionState()
    {
        ...
        if(active && counter >= 8)
        {
            ...
            if(!canEntityBeSeen(entityToAttack) || getDistanceToEntity(entityToAttack) >= 16F)
            {
                lostyou++;
                if(lostyou >= 4)
                {
