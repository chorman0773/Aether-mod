...
//            RenderPlayer, ModelBiped, EntityPlayer, World, 
//            mod_Aether, PlayerBaseAether, InventoryAether, ItemStack, 
//            AetherItems, Item, Entity, InventoryPlayer, 
//            EntityPlayerSP, ItemMoreArmor, ModelRenderer, RenderManager, 
//            ModLoader, MathHelper, GuiMainMenu, EntityLiving
...
public class RenderPlayerAether extends RenderPlayer
{
            ...
            float f, float f1)
    {
        ...
        modelEnergyShield.field_1278_i = itemstack == null ? 0 : 1;
        ...
        modelEnergyShield.field_1278_i = 0;
    }
    ...
    {
        ItemStack itemstack = entityplayer.inventory.getCurrentItem();
        modelMisc.field_1278_i = itemstack == null ? 0 : 1;
            ...
            float f, float f1)
    {
        ...
        modelMisc.onGround = renderSwingProgress(entityplayer, f1);
        ...
        try
        {
            ...
            renderLivingAt(entityplayer, d, d1, d2);
            float f5 = handleRotationFloat(entityplayer, f1);
    ...
    public void renderCape(EntityPlayer entityplayer, float f)
    {
        ...
        if(inventoryaether.slots[1] != null)
        {
            ...
            float f5 = entityplayer.prevCameraYaw + (entityplayer.cameraYaw - entityplayer.prevCameraYaw) * f;
    ...
    public boolean invisible(EntityPlayer entityplayer)
    {
        ...
        InventoryAether inventoryaether = mod_Aether.getPlayer(entityplayer).inv;
        return !entityplayer.isSwinging && inventoryaether.slots[1] != null && inventoryaether.slots[1].itemID == AetherItems.InvisibilityCloak.shiftedIndex;
    }
            ...
            float f, float f1)
    {
        GL11.glPushMatrix();
        GL11.glEnable(2884 /*GL_CULL_FACE*/);
        modelEnergyShield.onGround = renderSwingProgress(entityliving, f1);
        ...
        try
        {
            ...
            {
                modelEnergyShield.render(entityliving, f8, f7, f5, f3 - f2, f4, f6);
                GL11.glDisable(3042 /*GL_BLEND*/);
                GL11.glEnable(3008 /*GL_ALPHA_TEST*/);
            }
            GL11.glDisable(32826 /*GL_RESCALE_NORMAL_EXT*/);
