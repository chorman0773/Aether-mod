...
//            NBTTagList, EnchantmentAether, AetherItems, Item, 
    ...
    implements IInventory
{
    ...
    public void updateEntity()
    {
        ...
        if(currentEnchantment == null)
        {
            ...
            {
                if(itemstack == null || enchantments.get(i) == null || itemstack.itemID != ((EnchantmentAether)enchantments.get(i)).enchantFrom.itemID)
                {
                    continue;
                }
                if(enchanterItemStacks[2] == null)
                {
                    currentEnchantment = (EnchantmentAether)enchantments.get(i);
                    enchantTimeForItem = currentEnchantment.enchantPowerNeeded;
                    continue;
                }
                if(enchanterItemStacks[2].itemID == ((EnchantmentAether)enchantments.get(i)).enchantTo.itemID && ((EnchantmentAether)enchantments.get(i)).enchantTo.getItem().getItemStackLimit() > enchanterItemStacks[2].stackSize)
                {
                    currentEnchantment = (EnchantmentAether)enchantments.get(i);
                    enchantTimeForItem = currentEnchantment.enchantPowerNeeded;
                }
    ...
    {
        enchantments.add(new EnchantmentAether(itemstack, itemstack1, i));
    }
