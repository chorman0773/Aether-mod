...
/*
    ...
    private static final EnumEnchantmentType allEnchantmentTypes[];
    ...
    private EnumEnchantmentType(String s, int i, String s1, int j)
    {
        super(s, i);
    }
    ...
    static 
    {
        all = new EnumEnchantmentType("all", 0, "all", 0);
        armor = new EnumEnchantmentType("armor", 1, "armor", 1);
        armor_feet = new EnumEnchantmentType("armor_feet", 2, "armor_feet", 2);
        armor_legs = new EnumEnchantmentType("armor_legs", 3, "armor_legs", 3);
        armor_torso = new EnumEnchantmentType("armor_torso", 4, "armor_torso", 4);
        armor_head = new EnumEnchantmentType("armor_head", 5, "armor_head", 5);
        weapon = new EnumEnchantmentType("weapon", 6, "weapon", 6);
        digger = new EnumEnchantmentType("digger", 7, "digger", 7);
