...
//            GuiContainerCreative, EntityPlayerSP, RenderEngine, RenderHelper, 
//            RenderManager, GuiButton, GuiAchievements, GuiStats, 
//            PotionEffect, Potion, StatCollector, FontRenderer
...
public class GuiInventoryMoreSlots extends GuiContainer
{
    ...
    {
        int k = mc.renderEngine.getTexture("/aether/gui/inventory.png");
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(l + 33, i1 + 75, 50F);
        float f1 = 30F;
