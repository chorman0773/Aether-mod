...
//            Entity, mod_Aether, DamageSource, Material, 
//            EntityFiroBall, AetherBlocks, Block, BlockFire, 
//            NBTTagCompound, ModLoader, GuiIngame, EntityFireMinion, 
//            ItemStack, AetherItems, AetherAchievements
    ...
    implements IAetherBoss
{
    ...
    public void makeFireBall(int i)
    {
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            worldObj.spawnEntityInWorld(entityfiroball);
        }
    ...
    {
        if(damagesource.getEntity() == null || !(damagesource.getEntity() instanceof EntityFiroBall))
        {
            return false;
        }
        speedness = 0.5D - ((double)health / 70D) * 0.20000000000000001D;
        ...
        if(flag)
        {
            ...
            worldObj.spawnEntityInWorld(entityfireminion);
            worldObj.spawnEntityInWorld(entityfireminion);
            worldObj.spawnEntityInWorld(entityfireminion);
            if(health <= 0)
            {
