...
public final class EnumRarity extends Enum
{
    ...
    private static final EnumRarity allRarities[];
    ...
    private EnumRarity(String s, int i, String s1, int j, int k, String s2)
    {
        super(s, i);
        field_40535_e = k;
        field_40532_f = s2;
    ...
    static 
    {
        common = new EnumRarity("common", 0, "common", 0, 15, "Common");
        uncommon = new EnumRarity("uncommon", 1, "uncommon", 1, 14, "Uncommon");
        rare = new EnumRarity("rare", 2, "rare", 2, 11, "Rare");
        epic = new EnumRarity("epic", 3, "epic", 3, 13, "Epic");
