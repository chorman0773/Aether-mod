...
public class RenderXPOrb extends Render
{
            ...
            float f, float f1)
    {
        ...
        float f7 = 0.5F;
        float f8 = 0.25F;
        int j = entityxporb.getEntityBrightnessForRender(f1);
        float f9 = j % 0x10000;
        int k = j / 0x10000;
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapEnabled, f9 / 1.0F, (float)k / 1.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f10 = 255F;
        f9 = ((float)entityxporb.xpColor + f1) / 2.0F;
        k = (int)((MathHelper.sin(f9 + 0.0F) + 1.0F) * 0.5F * f10);
        int l = (int)f10;
        int i1 = (int)((MathHelper.sin(f9 + 4.18879F) + 1.0F) * 0.1F * f10);
        int j1 = k << 16 | l << 8 | i1;
        ...
        tessellator.setColorRGBA_I(j1, 128);
