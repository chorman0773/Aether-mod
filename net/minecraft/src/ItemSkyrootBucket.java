...
//            AetherItem, Block, ItemStack, EntityPlayer, 
...
public class ItemSkyrootBucket extends AetherItem
{
    ...
    public static int sprEmpty = 10;
    public static int sprWater = 14;
    public static int sprMilk = 11;
    public static int sprPoison = 12;
    public static int sprRemedy = 13;
