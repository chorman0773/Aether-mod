...
//            Vec3D, World, MovingObjectPosition, DamageSource, 
//            NBTTagCompound, EntityPlayer, ItemStack, Item, 
//            InventoryPlayer, EntitySlider
    ...
    public void onUpdate()
    {
        ...
        if(!worldObj.multiplayerWorld)
        {
            ...
            for(int k = 0; k < list.size(); k++)
            {
                ...
                if(entity1 != thrower)
                {
                    entity1.attackEntityFrom(DamageSource.causeMobDamage(thrower), 5);
                }
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(thrower), 0));
