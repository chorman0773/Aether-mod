...
public class Chunk
{
    ...
    public void setChunkBlockTileEntity(int i, int j, int k, TileEntity tileentity)
    {
        ...
        TileEntity tileentity1 = (TileEntity)chunkTileEntityMap.get(chunkposition);
        if(tileentity1 != null)
        {
            ...
            int k1)
    {
        ...
        Iterator iterator1 = chunkTileEntityMap.values().iterator();
        do
        {
            ...
            if((tileentity1.xCoord & 0xf) >= i && (tileentity1.xCoord & 0xf) <= l && tileentity1.yCoord >= j && tileentity1.yCoord <= i1 && (tileentity1.zCoord & 0xf) >= k && (tileentity1.zCoord & 0xf) <= j1)
            {
                Block block = tileentity1.getBlockType();
                if(block == null || block.blockID != worldObj.getBlockId(tileentity1.xCoord, tileentity1.yCoord, tileentity1.zCoord) || tileentity1.getBlockMetadata() != worldObj.getBlockMetadata(tileentity1.xCoord, tileentity1.yCoord, tileentity1.zCoord))
                {
