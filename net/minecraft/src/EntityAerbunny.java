...
//            EntityMob, DamageSource, Block, ItemStack, 
//            Item, InventoryPlayer, mod_Aether, EntityAnimal
...
public class EntityAerbunny extends EntityAetherAnimal
{
    ...
    public void onUpdate()
    {
        ...
        } else
        {
            ...
            for(int k = 0; k < list.size(); k++)
            {
                ...
                worldObj.spawnEntityInWorld(entityaerbunny1);
    ...
    public boolean attackEntityFrom(DamageSource damagesource, int i)
    {
        ...
        if(flag && damagesource.func_40545_l().equals("player"))
        {
            fear = true;
        }
        return flag;
    ...
    {
        return new EntityAerbunny(worldObj);
    }
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        if(itemstack != null && func_40143_a(itemstack))
        {
