...
//            Tessellator, FontRenderer, StatFileWriter
...
class GuiSlotStatsGeneral extends GuiSlot
{
    ...
    protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator)
    {
        ...
        field_27276_a.drawString(GuiStats.getFontRenderer1(field_27276_a), statbase.statName, j + 2, k + 1, i % 2 == 0 ? 0xffffff : 0x909090);
        String s = statbase.func_27084_a(GuiStats.getStatsFileWriter(field_27276_a).writeStat(statbase));
        field_27276_a.drawString(GuiStats.getFontRenderer2(field_27276_a), s, (j + 2 + 213) - GuiStats.getFontRenderer3(field_27276_a).getStringWidth(s), k + 1, i % 2 == 0 ? 0xffffff : 0x909090);
    }
}
