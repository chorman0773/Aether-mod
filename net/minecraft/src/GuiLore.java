...
//            AetherItems, Item, RenderEngine, Block, 
//            AetherBlocks, InventoryPlayer
...
label0:
    ...
    {
        int k = mc.renderEngine.getTexture("/aether/gui/lore.png");
    ...
    static 
    {
        ...
        lores.add(new Lore(Block.music, "Note Block", "Plays a note when", "powered. The", "block underneath", "defines the sound.", "Right click to", "change the note", 0));
        ...
        lores.add(new Lore(Item.map, "Map", "Made from paper", "and a compass.", "Makes a map of the", "area you are in", "", "", 0));
