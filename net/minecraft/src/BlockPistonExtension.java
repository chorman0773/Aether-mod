...
public class BlockPistonExtension extends Block
{
    ...
    public void onBlockRemoval(World world, int i, int j, int k)
    {
        ...
        int i1 = Facing.field_31057_a[func_31050_c(l)];
        ...
        if(j1 == Block.pistonBase.blockID || j1 == Block.pistonStickyBase.blockID)
        {
            ...
            if(BlockPistonBase.isExtended(k1))
            {
                Block.blocksList[j1].dropBlockAsItem(world, i, j, k, k1, 0);
    ...
    public int getBlockTextureFromSideAndMetadata(int i, int j)
    {
        ...
        {
            return i == Facing.field_31057_a[k] ? 107 : 108;
        }
    }
