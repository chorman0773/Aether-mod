...
//            ContainerPlayer, World, ChunkCoordinates, mod_Aether, 
//            PlayerBaseAether, DataWatcher, ItemStack, Item, 
//            EnumAction, Container, StatList, Vec3D, 
//            Potion, PotionEffect, MathHelper, AxisAlignedBB, 
//            Entity, EnchantmentHelper, EntityItem, Material, 
//            NBTTagCompound, NBTTagList, DamageSource, EntityMob, 
//            EntityArrow, EntityCreeper, EntityGhast, EntityWolf, 
//            AchievementList, EnumStatus, WorldProvider, BlockBed, 
//            Block, IChunkProvider, EntityMinecart, EntityBoat, 
//            EntityPig, ItemPotion, EntityFishHook, IInventory, 
//            TileEntityFurnace, TileEntityDispenser, TileEntitySign, TileEntityBrewingStand, 
//            StatBase
...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        if(mod_Aether.getPlayer() != null)
        {
            return mod_Aether.getPlayer().maxHealth;
        } else
        {
            return 20;
        }
    ...
    public float getCurrentPlayerStrVsBlock(Block block, int i)
    {
        ...
        if(itemstack != null)
        {
            f = itemstack.getItem().getStrVsBlock(itemstack, block, i);
        }
    ...
    protected void damageEntity(DamageSource damagesource, int i)
    {
        ...
        for(int l = 0; l < k; l++)
        {
            ...
            if(itemstack != null && (itemstack.getItem() instanceof ISpecialArmor))
            {
                ...
                ArmorProperties armorproperties = ispecialarmor.getProperties(this, j, i);
                i -= armorproperties.damageRemove;
                flag = flag && armorproperties.allowRegularComputation;
            }
        }
    ...
    {
        EnumStatus enumstatus = ForgeHooks.sleepInBedAt(this, i, j, k);
        if(enumstatus != null)
        {
            return enumstatus;
        }
