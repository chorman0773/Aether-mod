...
//            SAPI, MouseFilter, GLAllocation, ItemRenderer, 
//            RenderEngine, GameSettings, EntityLiving, MathHelper, 
//            World, PlayerController, MovingObjectPosition, Vec3D, 
//            AxisAlignedBB, Entity, EntityPlayerSP, EntityPlayer, 
//            ActiveRenderInfo, Block, Material, RenderGlobal, 
//            Potion, OpenGlHelper, WorldProvider, Profiler, 
//            MouseHelper, ScaledResolution, GuiIngame, GuiScreen, 
//            GuiParticle, ChunkProviderLoadOrGenerate, EffectRenderer, IChunkProvider, 
//            ClippingHelperImpl, Frustrum, RenderHelper, InventoryPlayer, 
//            WorldChunkManager, BiomeGenBase, EntitySmokeFX, EntityRainFX, 
//            Tessellator, PotionEffect
...
public class EntityRenderer
{
    ...
    public void getMouseOver(float f)
    {
        if(mc.renderViewEntity != null && mc.theWorld != null)
        {
            ...
            float f1 = SAPI.Reach.getReach(true);
            ...
            pointedEntity = null;
            float f2 = 1.0F;
            java.util.List list = mc.theWorld.getEntitiesWithinAABBExcludingEntity(mc.renderViewEntity, mc.renderViewEntity.boundingBox.addCoord(vec3d1.xCoord * d, vec3d1.yCoord * d, vec3d1.zCoord * d).expand(f2, f2, f2));
            double d2 = 0.0D;
