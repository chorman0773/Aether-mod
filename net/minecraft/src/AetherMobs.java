...
//            RenderAerbunny, ModelAerbunny, RenderWhirly, EntityTNTPresent, 
//            RenderTNTPresent
...
public class AetherMobs
{
    ...
    public AetherMobs()
    {
        ...
        ModLoader.RegisterEntityID(net.minecraft.src.EntityCockatrice.class, "Cockatrice", 101);
        ModLoader.RegisterEntityID(net.minecraft.src.EntitySwet.class, "Swets", 102);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityZephyr.class, "Zephyr", 103);
        ModLoader.RegisterEntityID(net.minecraft.src.EntitySheepuff.class, "Sheepuff", 104);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityPhyg.class, "FlyingPig", 105);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityAechorPlant.class, "AechorPlant", 106);
        ModLoader.RegisterEntityID(net.minecraft.src.EntitySentry.class, "Sentry", 107);
        ModLoader.RegisterEntityID(net.minecraft.src.EntitySlider.class, "Slider", 108);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityValkyrie.class, "Valkyrie", 109);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityHomeShot.class, "HomeShot", 110);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityFireMonster.class, "Fire Monster", 111);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityFireMinion.class, "Fire Minion", 112);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityFiroBall.class, "Firo Ball", 113);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityMoa.class, "MoaBase", 114);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityFlyingCow.class, "FlyingCow", 115);
        ModLoader.RegisterEntityID(net.minecraft.src.EntityAerbunny.class, "Aerbunny", 116);
        ModLoader.RegisterEntityID(net.minecraft.src.Whirly.class, "Whirlwind", 117);
    }
    ...
    public static void AddRenderer(Map map)
    {
        ...
        map.put(net.minecraft.src.EntityTNTPresent.class, new RenderTNTPresent());
    }
}
