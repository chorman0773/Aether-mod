...
//            ItemStack, Item, mod_Aether, EntityAnimal
...
public class EntityFlyingCow extends EntityAetherAnimal
{
    ...
    {
        return new EntityFlyingCow(worldObj);
    }

    public boolean interact(EntityPlayer entityplayer)
    {
        if(!getSaddled && entityplayer.inventory.getCurrentItem() != null && entityplayer.inventory.getCurrentItem().itemID == Item.saddle.shiftedIndex && !func_40127_l())
        {
