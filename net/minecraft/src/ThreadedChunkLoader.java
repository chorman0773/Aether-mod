...
//            IChunkLoader, IThreadedFileIO, ChunkCoordIntPair, World, 
//            NBTTagCompound, ThreadedChunkLoaderPending, RegionFileCache, CompressedStreamTools, 
//            ChunkLoader, Chunk, ThreadedFileIOBase
    ...
    implements IChunkLoader, IThreadedFileIO
{
        ...
        throws IOException
    {
        ...
        {
            DataInputStream datainputstream = RegionFileCache.getChunkInputStream(field_40553_d, i, j);
    ...
    public void saveChunk(World world, Chunk chunk)
    {
        ...
        try
        {
            ...
            func_40552_a(chunk.getChunkCoordIntPair(), nbttagcompound);
        }
