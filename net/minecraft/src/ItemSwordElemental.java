    ...
    implements ITextureProvider
{
    ...
    public boolean hitEntity(ItemStack itemstack, EntityLiving entityliving, EntityLiving entityliving1)
    {
        ...
        {
            entityliving.func_40046_d(30);
        } else
        if(element == EnumElement.Lightning)
        {
            ModLoader.getMinecraftInstance().theWorld.spawnEntityInWorld(new EntityAetherLightning(ModLoader.getMinecraftInstance().theWorld, (int)entityliving.posX, (int)entityliving.posY, (int)entityliving.posZ));
        }
