...
//            World, ItemPotion, ItemFlintAndSteel, ItemFood, 
//            ItemBow, ItemCoal, ItemSoup, ItemPainting, 
//            ItemSign, ItemMinecart, ItemSaddle, ItemSnowball, 
//            ItemBoat, ItemEgg, ItemFishingRod, ItemDye, 
//            ItemBed, ItemMap, ItemShears, ItemEnderPearl, 
//            ItemGlassBottle, ItemEnderEye, ItemRecord, ItemSpade, 
//            EnumToolMaterial, ItemPickaxe, ItemAxe, ItemSword, 
//            ItemHoe, ItemSeeds, Block, ItemArmor, 
//            EnumArmorMaterial, ItemAppleGold, Potion, ItemDoor, 
//            Material, ItemBucket, ItemRedstone, ItemBucketMilk, 
//            ItemReed, StatList, EntityLiving, Entity, 
...
public class Item
{
    ...
    public static Item gunpowder = (new Item(33)).setIconCoord(8, 2).setItemName("sulphur").setPotionModifier("+14&13-13");
    ...
    public static Item redstone = (new ItemRedstone(75)).setIconCoord(8, 3).setItemName("redstone").setPotionModifier("-5+6-7");
    ...
    public static Item lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust").setPotionModifier("+5-6-7");
    ...
    public static Item sugar = (new Item(97)).setIconCoord(13, 0).setItemName("sugar").setPotionModifier("-0+1-2-3&4-4+13");
    ...
    public static Item ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").setPotionModifier("+0-1-2-3&4-4+13");
    ...
    public static Item fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye").setPotionModifier("-0+3-4+13");
    public static Item blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder").setPotionModifier("+0-1-2+3&4-4+13");
    public static Item magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream").setPotionModifier("+0+1-2-3&4-4+13");
    ...
    public static Item speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon").setPotionModifier("+0-1+2-3&4-4+13");
    ...
    {
        if(shiftedIndex != potion.shiftedIndex)
        {
    ...
    static 
    {
        ...
        spiderEye = (new ItemFood(119, 2, 0.8F, false)).setPotionEffect(Potion.potionPoison.id, 5, 0, 1.0F).setIconCoord(11, 8).setItemName("spiderEye").setPotionModifier("-0-1+2-3&4-4+13");
