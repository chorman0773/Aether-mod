...
public class ModelAechorPlant extends ModelBase
{
    ...
    public ModelAechorPlant(float f, float f1)
    {
        ...
        for(int i = 0; i < petals; i++)
        {
            ...
            if(i % 2 == 0)
            {
                petal[i] = new ModelRenderer(this, 29, 3);
        ...
        {
            stamen[j] = new ModelRenderer(this, 36, 13);
        ...
        {
            stamen2[k] = new ModelRenderer(this, 32, 15);
        ...
        stem = new ModelRenderer(this, 24, 13);
        ...
        {
            thorn[l] = new ModelRenderer(this, 32, 13);
