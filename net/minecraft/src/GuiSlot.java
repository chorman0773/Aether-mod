...
public abstract class GuiSlot
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        tessellator.addVertexWithUV(0.0D, bottom, 0.0D, 0.0F / f1, (float)(bottom + (int)amountScrolled) / f1);
        ...
        tessellator.addVertexWithUV(0.0D, top, 0.0D, 0.0F / f1, (float)(top + (int)amountScrolled) / f1);
        tessellator.draw();
