...
//            IBlockAccess, Block, MathHelper, ModLoader, 
//            BlockBrewingStand, BlockCauldron, BlockFenceGate, BlockPane, 
//            BlockFence, BlockDragonEgg, BlockRail, BlockEndPortalFrame, 
...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block block, int i, int j, int k)
    {
        ...
        return l == 0 ? renderStandardBlock(block, i, j, k) : l == 4 ? renderBlockFluids(block, i, j, k) : l == 13 ? renderBlockCactus(block, i, j, k) : l == 1 ? renderBlockReed(block, i, j, k) : l == 19 ? renderBlockStem(block, i, j, k) : l == 23 ? renderBlockLilyPad(block, i, j, k) : l == 6 ? renderBlockCrops(block, i, j, k) : l == 2 ? renderBlockTorch(block, i, j, k) : l == 3 ? renderBlockFire(block, i, j, k) : l == 5 ? renderBlockRedstoneWire(block, i, j, k) : l == 8 ? renderBlockLadder(block, i, j, k) : l == 7 ? renderBlockDoor(block, i, j, k) : l == 9 ? renderBlockMinecartTrack((BlockRail)block, i, j, k) : l == 10 ? renderBlockStairs(block, i, j, k) : l == 27 ? func_41088_a((BlockDragonEgg)block, i, j, k) : l == 11 ? renderBlockFence((BlockFence)block, i, j, k) : l == 12 ? renderBlockLever(block, i, j, k) : l == 14 ? renderBlockBed(block, i, j, k) : l == 15 ? renderBlockRepeater(block, i, j, k) : l == 16 ? renderPistonBase(block, i, j, k, false) : l == 17 ? renderPistonExtension(block, i, j, k, true) : l == 18 ? renderBlockPane((BlockPane)block, i, j, k) : l == 20 ? renderBlockVine(block, i, j, k) : l == 21 ? renderBlockFenceGate((BlockFenceGate)block, i, j, k) : l == 24 ? renderBlockCauldron((BlockCauldron)block, i, j, k) : l == 25 ? renderBlockBrewingStand((BlockBrewingStand)block, i, j, k) : l == 26 ? renderBlockEndPortalFrame(block, i, j, k) : ModLoader.RenderWorldBlock(this, blockAccess, i, j, k, block, l);
    }
    ...
    public boolean renderBlockBed(Block block, int i, int j, int k)
    {
        ...
        {
            tessellator.setBrightness(block.minZ > 0.0D ? j1 : block.getMixedBrightnessForBlock(blockAccess, i, j, k - 1));
        ...
        {
            tessellator.setBrightness(block.maxZ < 1.0D ? j1 : block.getMixedBrightnessForBlock(blockAccess, i, j, k + 1));
            tessellator.setColorOpaque_F(f2, f2, f2);
            flipTexture = byte0 == 3;
        ...
        {
            tessellator.setBrightness(block.minZ > 0.0D ? j1 : block.getMixedBrightnessForBlock(blockAccess, i - 1, j, k));
        ...
        {
            tessellator.setBrightness(block.maxZ < 1.0D ? j1 : block.getMixedBrightnessForBlock(blockAccess, i + 1, j, k));
            tessellator.setColorOpaque_F(f3, f3, f3);
            flipTexture = byte0 == 5;
    ...
    public boolean renderBlockFire(Block block, int i, int j, int k)
    {
        ...
        if(!blockAccess.isBlockNormalCube(i, j - 1, k) && !Block.fire.canBlockCatchFire(blockAccess, i, j - 1, k, 0))
        {
            ...
            {
                double d6 = (double)i + 0.5D + 0.5D;
                double d8 = ((double)i + 0.5D) - 0.5D;
                double d10 = (double)k + 0.5D + 0.5D;
                double d12 = ((double)k + 0.5D) - 0.5D;
                double d14 = ((double)i + 0.5D) - 0.5D;
                double d16 = (double)i + 0.5D + 0.5D;
                double d18 = ((double)k + 0.5D) - 0.5D;
                ...
                if((i + j + k & 1) == 0)
                {
                    ...
                    d2 = (float)(j1 + 16) / 256F;
                    d3 = ((float)j1 + 15.99F + 16F) / 256F;
                    tessellator.addVertexWithUV(d16, (float)j + f, k + 1, d1, d2);
                    tessellator.addVertexWithUV(d8, j + 0, k + 1, d1, d3);
                    tessellator.addVertexWithUV(d8, j + 0, k + 0, d, d3);
                    tessellator.addVertexWithUV(d16, (float)j + f, k + 0, d, d2);
                } else
                {
                    tessellator.addVertexWithUV(i + 0, (float)j + f, d20, d1, d2);
                    tessellator.addVertexWithUV(i + 0, j + 0, d12, d1, d3);
                    tessellator.addVertexWithUV(i + 1, j + 0, d12, d, d3);
        ...
        } else
        {
            ...
            double d7 = ((double)i + 0.5D) - 0.20000000000000001D;
            double d9 = (double)k + 0.5D + 0.20000000000000001D;
            double d11 = ((double)k + 0.5D) - 0.20000000000000001D;
            double d13 = ((double)i + 0.5D) - 0.29999999999999999D;
            double d15 = (double)i + 0.5D + 0.29999999999999999D;
            double d17 = ((double)k + 0.5D) - 0.29999999999999999D;
            double d19 = (double)k + 0.5D + 0.29999999999999999D;
            tessellator.addVertexWithUV(d13, (float)j + f, k + 1, d1, d2);
            tessellator.addVertexWithUV(d4, j + 0, k + 1, d1, d3);
            tessellator.addVertexWithUV(d4, j + 0, k + 0, d, d3);
            tessellator.addVertexWithUV(d13, (float)j + f, k + 0, d, d2);
            tessellator.addVertexWithUV(d15, (float)j + f, k + 0, d1, d2);
            tessellator.addVertexWithUV(d7, j + 0, k + 0, d1, d3);
            tessellator.addVertexWithUV(d7, j + 0, k + 1, d, d3);
            tessellator.addVertexWithUV(d15, (float)j + f, k + 1, d, d2);
            d = (float)i1 / 256F;
            d1 = ((float)i1 + 15.99F) / 256F;
            d2 = (float)(j1 + 16) / 256F;
            d3 = ((float)j1 + 15.99F + 16F) / 256F;
            tessellator.addVertexWithUV(i + 1, (float)j + f, d19, d1, d2);
            tessellator.addVertexWithUV(i + 1, j + 0, d11, d1, d3);
            tessellator.addVertexWithUV(i + 0, j + 0, d11, d, d3);
            tessellator.addVertexWithUV(i + 0, (float)j + f, d19, d, d2);
            tessellator.addVertexWithUV(i + 0, (float)j + f, d17, d1, d2);
            tessellator.addVertexWithUV(i + 0, j + 0, d9, d1, d3);
            tessellator.addVertexWithUV(i + 1, j + 0, d9, d, d3);
            tessellator.addVertexWithUV(i + 1, (float)j + f, d17, d, d2);
            d4 = ((double)i + 0.5D) - 0.5D;
            d7 = (double)i + 0.5D + 0.5D;
            d9 = ((double)k + 0.5D) - 0.5D;
            d11 = (double)k + 0.5D + 0.5D;
            d13 = ((double)i + 0.5D) - 0.40000000000000002D;
            d15 = (double)i + 0.5D + 0.40000000000000002D;
            d17 = ((double)k + 0.5D) - 0.40000000000000002D;
            d19 = (double)k + 0.5D + 0.40000000000000002D;
            tessellator.addVertexWithUV(d13, (float)j + f, k + 0, d, d2);
            tessellator.addVertexWithUV(d4, j + 0, k + 0, d, d3);
            tessellator.addVertexWithUV(d4, j + 0, k + 1, d1, d3);
            tessellator.addVertexWithUV(d13, (float)j + f, k + 1, d1, d2);
    ...
    public boolean renderBlockRedstoneWire(Block block, int i, int j, int k)
    {
        ...
        if(byte0 == 0)
        {
            ...
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f8, d1, d3);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f7, d1, d2);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f7, d, d2);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f8, d, d3);
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f8, d1, d3 + 0.0625D);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f7, d1, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f7, d, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f8, d, d3 + 0.0625D);
        } else
        if(byte0 == 1)
        {
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f8, d1, d3);
        ...
        {
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f8, d1, d3);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f7, d, d3);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f7, d, d2);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f8, d1, d2);
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f8, d1, d3 + 0.0625D);
            tessellator.addVertexWithUV(f6, (double)j + 0.015625D, f7, d, d3 + 0.0625D);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f7, d, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (double)j + 0.015625D, f8, d1, d2 + 0.0625D);
        }
        if(!blockAccess.isBlockNormalCube(i, j + 1, k))
        {
            ...
            if(blockAccess.isBlockNormalCube(i - 1, j, k) && blockAccess.getBlockId(i - 1, j + 1, k) == Block.redstoneWire.blockID)
            {
                ...
                tessellator.addVertexWithUV((double)i + 0.015625D, (float)(j + 1) + 0.021875F, k + 1, d5, d6);
                tessellator.addVertexWithUV((double)i + 0.015625D, j + 0, k + 1, d4, d6);
                tessellator.addVertexWithUV((double)i + 0.015625D, j + 0, k + 0, d4, d7);
                tessellator.addVertexWithUV((double)i + 0.015625D, (float)(j + 1) + 0.021875F, k + 0, d5, d7);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((double)i + 0.015625D, (float)(j + 1) + 0.021875F, k + 1, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)i + 0.015625D, j + 0, k + 1, d4, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)i + 0.015625D, j + 0, k + 0, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)i + 0.015625D, (float)(j + 1) + 0.021875F, k + 0, d5, d7 + 0.0625D);
            }
            if(blockAccess.isBlockNormalCube(i + 1, j, k) && blockAccess.getBlockId(i + 1, j + 1, k) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, j + 0, k + 1, d4, d7);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, (float)(j + 1) + 0.021875F, k + 1, d5, d7);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, (float)(j + 1) + 0.021875F, k + 0, d5, d6);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, j + 0, k + 0, d4, d6);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, j + 0, k + 1, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, (float)(j + 1) + 0.021875F, k + 1, d5, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, (float)(j + 1) + 0.021875F, k + 0, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)(i + 1) - 0.015625D, j + 0, k + 0, d4, d6 + 0.0625D);
            }
            if(blockAccess.isBlockNormalCube(i, j, k - 1) && blockAccess.getBlockId(i, j + 1, k - 1) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV(i + 1, j + 0, (double)k + 0.015625D, d4, d7);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (double)k + 0.015625D, d5, d7);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (double)k + 0.015625D, d5, d6);
                tessellator.addVertexWithUV(i + 0, j + 0, (double)k + 0.015625D, d4, d6);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(i + 1, j + 0, (double)k + 0.015625D, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (double)k + 0.015625D, d5, d7 + 0.0625D);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (double)k + 0.015625D, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV(i + 0, j + 0, (double)k + 0.015625D, d4, d6 + 0.0625D);
            }
            if(blockAccess.isBlockNormalCube(i, j, k + 1) && blockAccess.getBlockId(i, j + 1, k + 1) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (double)(k + 1) - 0.015625D, d5, d6);
                tessellator.addVertexWithUV(i + 1, j + 0, (double)(k + 1) - 0.015625D, d4, d6);
                tessellator.addVertexWithUV(i + 0, j + 0, (double)(k + 1) - 0.015625D, d4, d7);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (double)(k + 1) - 0.015625D, d5, d7);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (double)(k + 1) - 0.015625D, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV(i + 1, j + 0, (double)(k + 1) - 0.015625D, d4, d6 + 0.0625D);
                tessellator.addVertexWithUV(i + 0, j + 0, (double)(k + 1) - 0.015625D, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (double)(k + 1) - 0.015625D, d5, d7 + 0.0625D);
            }
        }
        return true;
    }
    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k)
    {
        ...
        for(int k1 = 0; k1 < 4; k1++)
        {
            ...
            tessellator.setBrightness(block.getMixedBrightnessForBlock(blockAccess, l1, j, j2));
            float f10 = 1.0F;
            if(k1 < 2)
            {
                f10 *= f5;
    ...
    public boolean renderStandardBlock(Block block, int i, int j, int k)
    {
        ...
        return Minecraft.isAmbientOcclusionEnabled() && Block.lightValue[block.blockID] == 0 ? renderStandardBlockWithAmbientOcclusion(block, i, j, k, f, f1, f2) : renderStandardBlockWithColorMultiplier(block, i, j, k, f, f1, f2);
    }
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            ...
            } else
            {
                ...
                f19 = aoLightValueYNeg;
                f13 = aoLightValueYNeg;
                f7 = aoLightValueYNeg;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
            ...
            } else
            {
                ...
                f20 = aoLightValueYPos;
                f14 = aoLightValueYPos;
                f8 = aoLightValueYPos;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            ...
            } else
            {
                ...
                f21 = aoLightValueZNeg;
                f15 = aoLightValueZNeg;
                f9 = aoLightValueZNeg;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            ...
            } else
            {
                ...
                f22 = aoLightValueZPos;
                f16 = aoLightValueZPos;
                f10 = aoLightValueZPos;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            ...
            } else
            {
                ...
                f23 = aoLightValueXNeg;
                f17 = aoLightValueXNeg;
                f11 = aoLightValueXNeg;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            ...
            } else
            {
                ...
                f24 = aoLightValueXPos;
                f18 = aoLightValueXPos;
                f12 = aoLightValueXPos;
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            tessellator.setBrightness(block.minY > 0.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i, j - 1, k));
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
            tessellator.setBrightness(block.maxY < 1.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i, j + 1, k));
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            tessellator.setBrightness(block.minZ > 0.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i, j, k - 1));
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            tessellator.setBrightness(block.maxZ < 1.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i, j, k + 1));
            tessellator.setColorOpaque_F(f11, f14, f17);
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            tessellator.setBrightness(block.minX > 0.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i - 1, j, k));
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            tessellator.setBrightness(block.maxX < 1.0D ? l : block.getMixedBrightnessForBlock(blockAccess, i + 1, j, k));
            tessellator.setColorOpaque_F(f12, f15, f18);
    ...
    {
        return i == 0 ? true : i == 13 ? true : i == 10 ? true : i == 11 ? true : i == 27 ? true : i == 22 ? true : i == 21 ? true : ModLoader.RenderBlockIsItemFull3D(i);
    }
