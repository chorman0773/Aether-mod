...
public class MapGenCavesHell extends MapGenBase
{
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            ...
            if(j2 > worldObj.worldHeight - 8)
            {
                j2 = worldObj.worldHeight - 8;
            }
            if(k2 < 0)
            {
                k2 = 0;
            ...
            for(int i3 = k1; !flag2 && i3 < l1; i3++)
            {
                for(int k3 = k2; !flag2 && k3 < l2; k3++)
                {
                    ...
                    {
                        int i4 = (i3 * 16 + k3) * worldObj.worldHeight + l3;
                        if(l3 < 0 || l3 >= worldObj.worldHeight)
                        {
                            continue;
                        }
                        if(abyte0[i4] == Block.lavaMoving.blockID || abyte0[i4] == Block.lavaStill.blockID)
                        {
                            flag2 = true;
                        }
            ...
            for(int j3 = k1; j3 < l1; j3++)
            {
                ...
                for(int j4 = k2; j4 < l2; j4++)
                {
                    ...
                    int k4 = (j3 * 16 + j4) * worldObj.worldHeight + j2;
