...
//            AetherItem, mod_Aether, EntityCloudParachute, AetherItems, 
...
public class ItemCloudParachute extends AetherItem
{
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        if(EntityCloudParachute.entityHasRoomForCloud(world, entityplayer))
        {
            ...
            world.spawnEntityInWorld(new EntityCloudParachute(world, entityplayer, shiftedIndex == AetherItems.CloudParachuteGold.shiftedIndex));
        }
        return itemstack;
    }
