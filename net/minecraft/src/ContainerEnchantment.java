...
//            Container, SlotEnchantmentTable, SlotEnchantment, InventoryPlayer, 
//            World, Slot, ICrafting, IInventory, 
//            ItemStack, Block, EnchantmentHelper, EntityPlayer, 
//            EnchantmentData
    ...
    public boolean enchantItem(EntityPlayer entityplayer, int i)
    {
        ...
        if(enchantLevels[i] > 0 && itemstack != null && entityplayer.playerLevel >= enchantLevels[i])
        {
            if(!worldPointer.multiplayerWorld)
            {
                ...
                if(list != null)
                {
                    entityplayer.func_40184_i(enchantLevels[i]);
