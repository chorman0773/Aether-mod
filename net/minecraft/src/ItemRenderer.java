...
//            RenderBlocks, MapItemRenderer, ItemStack, RenderEngine, 
//            EntityLiving, Block, Item, Tessellator, 
//            EntityPlayer, RenderHelper, EntityPlayerSP, MathHelper, 
//            World, OpenGlHelper, ItemMap, RenderManager, 
...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLiving entityliving, ItemStack itemstack, int i)
    {
        ...
        {
            String s = ForgeHooksClient.getTexture("/terrain.png", itemstack.getItem());
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture(s));
            ForgeHooksClient.renderCustomItem(icustomitemrenderer, renderBlocksInstance, itemstack.itemID, itemstack.getItemDamage(), entityliving.getEntityBrightness(1.0F));
        } else
        if(itemstack.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType()))
        {
            String s1 = ForgeHooksClient.getTexture("/terrain.png", Block.blocksList[itemstack.itemID]);
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture(s1));
            renderBlocksInstance.renderBlockOnInventory(Block.blocksList[itemstack.itemID], itemstack.getItemDamage(), 1.0F);
        } else
        {
            if(itemstack.itemID < 256)
            {
                String s2 = ForgeHooksClient.getTexture("/terrain.png", Block.blocksList[itemstack.itemID]);
                GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture(s2));
            } else
            {
                String s3 = ForgeHooksClient.getTexture("/gui/items.png", Item.itemsList[itemstack.itemID]);
                GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture(s3));
            }
    ...
    public void renderItemInFirstPerson(float f)
    {
        ...
        if(itemstack != null && itemstack.itemID == Item.map.shiftedIndex)
        {
            ...
            for(f15 = 0.0F; f15 < 2.0F; f15++)
            {
                ...
                GL11.glRotatef(-45F * f21, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(-90F, 0.0F, 0.0F, 1.0F);
                GL11.glRotatef(59F, 0.0F, 0.0F, 1.0F);
                GL11.glRotatef(-65F * f21, 0.0F, 1.0F, 0.0F);
            ...
            float f26 = MathHelper.sin(MathHelper.sqrt_float(f15) * 3.141593F);
            GL11.glRotatef(-f21 * 20F, 0.0F, 1.0F, 0.0F);
            GL11.glRotatef(-f26 * 20F, 0.0F, 0.0F, 1.0F);
            GL11.glRotatef(-f26 * 80F, 1.0F, 0.0F, 0.0F);
            f15 = 0.38F;
        ...
        if(itemstack != null)
        {
            ...
            if(entityplayersp.func_35205_Y() > 0)
            {
                ...
                if(enumaction == EnumAction.eat || enumaction == EnumAction.drink)
                {
                    ...
                    f28 = f28 * f28 * f28;
                    float f31 = 1.0F - f28;
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos((f16 / 4F) * 3.141593F) * 0.1F) * (float)((double)f27 > 0.20000000000000001D ? 1 : 0), 0.0F);
            ...
            if(entityplayersp.func_35205_Y() > 0)
            {
                ...
                if(enumaction1 == EnumAction.bow)
                {
                    ...
                    float f29 = (float)itemstack.getMaxItemUseDuration() - (((float)entityplayersp.func_35205_Y() - f) + 1.0F);
                    float f32 = f29 / 20F;
                    ...
                    if(f32 > 0.1F)
                    {
                        GL11.glTranslatef(0.0F, MathHelper.sin((f29 - 0.1F) * 1.3F) * 0.01F * (f32 - 0.1F), 0.0F);
                    }
                    GL11.glTranslatef(0.0F, 0.0F, f32 * 0.1F);
                    GL11.glRotatef(-335F, 0.0F, 0.0F, 1.0F);
                    GL11.glRotatef(-50F, 0.0F, 1.0F, 0.0F);
                    GL11.glTranslatef(0.0F, 0.5F, 0.0F);
                    float f33 = 1.0F + f32 * 0.2F;
        ...
        } else
        {
            ...
            float f25 = MathHelper.sin(MathHelper.sqrt_float(f13) * 3.141593F);
            GL11.glTranslatef(-f25 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(f13) * 3.141593F * 2.0F) * 0.4F, -f19 * 0.4F);
            ...
            f25 = MathHelper.sin(MathHelper.sqrt_float(f13) * 3.141593F);
            GL11.glRotatef(f25 * 70F, 0.0F, 1.0F, 0.0F);
