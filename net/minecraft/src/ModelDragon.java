...
//            ModelBase, ModelRenderer, EntityDragon, Entity, 
//            EntityLiving
...
public class ModelDragon extends ModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            field_40312_b.rotateAngleY = ((func_40307_a(ad2[0] - ad[0]) * 3.141593F) / 180F) * f11;
        ...
        for(int k = 0; k < 12; k++)
        {
            double ad3[] = entitydragon.func_40160_a(12 + k, field_40317_s);
            f14 = (float)((double)f14 + Math.sin((float)k * 0.45F + f15) * 0.05000000074505806D);
            field_40312_b.rotateAngleY = ((func_40307_a(ad3[0] - ad[0]) * f11 + 180F) * 3.141593F) / 180F;
