...
public class StructureNetherBridgeEnd extends ComponentNetherBridgePiece
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        for(int i = 0; i <= 4; i++)
        {
            for(int k = 3; k <= 4; k++)
            {
                int j1 = random1.nextInt(8);
                fillWithBlocks(world, structureboundingbox, i, k, 0, i, k, j1, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
            }
        ...
        for(int l = 0; l <= 4; l++)
        {
            int k1 = random1.nextInt(5);
            fillWithBlocks(world, structureboundingbox, l, 2, 0, l, 2, k1, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
        }
        ...
        for(int i1 = 0; i1 <= 4; i1++)
        {
            for(int l1 = 0; l1 <= 1; l1++)
            {
                ...
                fillWithBlocks(world, structureboundingbox, i1, l1, 0, i1, l1, i2, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
            }
