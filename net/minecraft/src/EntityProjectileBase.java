...
//            DamageSource, NBTTagCompound, ItemStack, InventoryPlayer
        ...
        if(movingobjectposition != null && onHit())
        {
            ...
            if(entity1 != null)
            {
                if(onHitTarget(entity1))
                {
                    ...
                    {
                        ((EntityLiving)entity1).naturalArmorRating = 0;
                    }
                    entity1.attackEntityFrom(DamageSource.causeThrownDamage(this, shooter), dmg);
                    setEntityDead();
                }
            } else
            {
