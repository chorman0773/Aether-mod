    ...
    implements IInventory, ISidedInventory
{
    ...
    private boolean func_40050_o()
    {
        ...
        for(int i = 0; i < 3; i++)
        {
            ...
            List list = Item.potion.func_40431_c_(j);
            List list1 = Item.potion.func_40431_c_(k);
    ...
    private int func_40051_b(int i, ItemStack itemstack)
    {
        ...
        if(Item.itemsList[itemstack.itemID].func_40406_n())
        {
            return PotionHelper.func_40356_a(i, Item.itemsList[itemstack.itemID].getPotionModifier());
        } else
        {
            return i;
        }
