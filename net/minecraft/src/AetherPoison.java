...
//            DamageSource, ScaledResolution, RenderEngine, Tessellator, 
//            RenderPoisonNeedle, RenderDartPoison, RenderDartGolden, RenderDartEnchanted
...
public class AetherPoison
{
    ...
    public static void tickRender(Minecraft minecraft)
    {
        ...
        if(clock != l)
        {
            ...
            if(i == 0)
            {
                minecraft.thePlayer.attackEntityFrom(DamageSource.generic, 1);
            }
            poisonTime--;
            clock = l;
        }
