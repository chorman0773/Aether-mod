...
//            AxisAlignedBB, EntityLiving, MovingObjectPosition, Entity, 
//            PotionEffect, Potion
...
public class EntityPotion extends EntityThrowable
{
    ...
    protected void func_40078_a(MovingObjectPosition movingobjectposition)
    {
        ...
        {
            List list = Item.potion.func_40431_c_(potionDamage);
                    ...
                    for(Iterator iterator = list1.iterator(); iterator.hasNext();)
                    {
                        ...
                        if(d < 16D)
                        {
                            ...
                            while(iterator1.hasNext()) 
                            {
                                ...
                                {
                                    Potion.potionTypes[i].affectEntity(field_40083_c, (EntityLiving)entity, potioneffect.getAmplifier(), d1);
                                } else
                                {
