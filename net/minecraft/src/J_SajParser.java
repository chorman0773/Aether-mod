...
public final class J_SajParser
{
        ...
        throws IOException, J_InvalidSyntaxException
    {
        ...
        default:
            throw new J_InvalidSyntaxException((new StringBuilder()).append("Expected a digit 1 - 9 but got [").append(c).append("].").toString(), j_positiontrackingpushbackreader);
        }
        return c1;
    }
        ...
        throws IOException, J_InvalidSyntaxException
    {
        ...
        case 117: // 'u'
            c1 = (char)hexadecimalNumber(j_positiontrackingpushbackreader);
            break;

        default:
            throw new J_InvalidSyntaxException((new StringBuilder()).append("Unrecognised escape character [").append(c).append("].").toString(), j_positiontrackingpushbackreader);
        }
        return c1;
    }
