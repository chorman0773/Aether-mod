...
//            AxisAlignedBB, EntityLiving, EntityAnimal, World, 
//            MathHelper, GameSettings, ModelBase, FontRenderer
...
public abstract class Render
{
            ...
            float f)
    {
        ...
        float f9 = (float)(entity.posY - entity.boundingBox.minY);
        ...
        while(f8 > 0.0F) 
        {
            ...
            {
                f11 = (float)j / 256F;
                f12 = ((float)j + 15.99F) / 256F;
                f13 = (float)k / 256F;
                f14 = ((float)k + 15.99F) / 256F;
            } else
            {
                f11 = (float)j / 256F;
                f12 = ((float)j + 15.99F) / 256F;
                f13 = (float)(k + 16) / 256F;
                f14 = ((float)(k + 16) + 15.99F) / 256F;
            }
            if((l / 2) % 2 == 0)
            {
                float f15 = f12;
            ...
            tessellator.addVertexWithUV(f6 - f7, 0.0F - f9, f10, f12, f14);
            tessellator.addVertexWithUV(-f6 - f7, 0.0F - f9, f10, f11, f14);
            tessellator.addVertexWithUV(-f6 - f7, 1.4F - f9, f10, f11, f13);
            tessellator.addVertexWithUV(f6 - f7, 1.4F - f9, f10, f12, f13);
            f8 -= 0.45F;
            f9 -= 0.45F;
            f6 *= 0.9F;
            f10 += 0.03F;
