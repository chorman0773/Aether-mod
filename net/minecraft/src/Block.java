...
//            StatList, EntityPlayer, EnchantmentHelper, Item, 
//            StatCollector, WorldProviderEnd, StepSound, StepSoundStone, 
//            StepSoundSand, BlockStone, BlockGrass, BlockDirt, 
...
//            ItemCloth, ItemMetadata, ItemSlab, ItemSapling, 
//            ItemLeaves, ItemColored, ItemLilyPad, ItemPiston, 
...
public class Block
{
    ...
    {
        return func_40198_a(j, random);
    }

    /**
     * @deprecated Method quantityDropped is deprecated
     */

    public int quantityDropped(int i, Random random)
    {
        return quantityDropped(i, 0, random);
    }
    ...
    /**
     * @deprecated Method getBlockDropped is deprecated
     */

    public ArrayList getBlockDropped(World world, int i, int j, int k, int l)
    {
        return getBlockDropped(world, i, j, k, l, 0);
    }
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int l, float f, int i1)
    {
        ...
        ArrayList arraylist = getBlockDropped(world, i, j, k, l, i1);
    ...
    public float blockStrength(World world, EntityPlayer entityplayer, int i, int j, int k)
    {
        ...
        return blockStrength(entityplayer, l);
    }
    ...
    protected static void setBurnRate(int i, int j, int k)
    {
