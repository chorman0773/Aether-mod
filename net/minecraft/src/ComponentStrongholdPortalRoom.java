...
public class ComponentStrongholdPortalRoom extends ComponentStronghold
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        for(int j = 2; j < 9; j += 2)
        {
            fillWithBlocks(world, structureboundingbox, j, 3, 15, j, 4, 15, Block.fenceIron.blockID, Block.fenceIron.blockID, false);
        }

        int k = func_35009_c(Block.stairsStoneBrickSmooth.blockID, 3);
        ...
        for(int l = 4; l <= 6; l++)
        {
            placeBlockAtCurrentPosition(world, Block.stairsStoneBrickSmooth.blockID, k, l, 1, 4, structureboundingbox);
            placeBlockAtCurrentPosition(world, Block.stairsStoneBrickSmooth.blockID, k, l, 2, 5, structureboundingbox);
            placeBlockAtCurrentPosition(world, Block.stairsStoneBrickSmooth.blockID, k, l, 3, 6, structureboundingbox);
        }
        ...
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte1 + (random.nextFloat() > 0.9F ? 4 : 0), 4, 3, 8, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte1 + (random.nextFloat() > 0.9F ? 4 : 0), 5, 3, 8, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte1 + (random.nextFloat() > 0.9F ? 4 : 0), 6, 3, 8, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte2 + (random.nextFloat() > 0.9F ? 4 : 0), 4, 3, 12, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte2 + (random.nextFloat() > 0.9F ? 4 : 0), 5, 3, 12, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte2 + (random.nextFloat() > 0.9F ? 4 : 0), 6, 3, 12, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte3 + (random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 9, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte3 + (random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 10, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte3 + (random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 11, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte4 + (random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 9, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte4 + (random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 10, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.endPortalFrame.blockID, byte4 + (random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 11, structureboundingbox);
        if(!field_40015_a)
        {
            int i1 = getYWithOffset(3);
            int j1 = getXWithOffset(5, 6);
            int k1 = getZWithOffset(5, 6);
            if(structureboundingbox.isVecInside(j1, i1, k1))
            {
                field_40015_a = true;
                world.setBlockWithNotify(j1, i1, k1, Block.mobSpawner.blockID);
                TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.getBlockTileEntity(j1, i1, k1);
