...
//            EnumAction, EntityPlayerSP, RenderManager, Tessellator, 
//            FontRenderer, Block, RenderBlocks, ItemRenderer, 
...
public class RenderPlayer extends RenderLiving
{
    ...
    protected int setArmorModel(EntityPlayer entityplayer, int i, float f)
    {
        ...
        if(itemstack != null)
        {
            ...
            if(item instanceof ItemArmor)
            {
                ...
                return itemstack.func_40711_u() ? 15 : 1;
            }
        }
        return -1;
    }
            ...
            float f, float f1)
    {
        ...
        modelArmorChestplate.field_1278_i = modelArmor.field_1278_i = modelBipedMain.field_1278_i = itemstack != null ? 1 : 0;
