...
public class EnumHelper
{
    ...
    public static EnumAction addAction(String s)
    {
        ...
        return (EnumAction)addEnum(decompiled[0], net.minecraft.src.EnumAction.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumArmorMaterial addArmorMaterial(String s, int i, int ai[], int j)
    {
        ...
        return (EnumArmorMaterial)addEnum(decompiled[1], net.minecraft.src.EnumArmorMaterial.class, s, new Class[] {
    ...
    public static EnumArt addArt(String s, String s1, int i, int j, int k, int l)
    {
        ...
        return (EnumArt)addEnum(decompiled[2], net.minecraft.src.EnumArt.class, s, new Class[] {
    ...
    public static EnumCreatureAttribute addCreatureAttribute(String s)
    {
        ...
        return (EnumCreatureAttribute)addEnum(decompiled[3], net.minecraft.src.EnumCreatureAttribute.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumCreatureType addCreatureType(String s, Class class1, int i, Material material, boolean flag)
    {
        ...
        return (EnumCreatureType)addEnum(decompiled[4], net.minecraft.src.EnumCreatureType.class, s, new Class[] {
    ...
    public static EnumDoor addDoor(String s)
    {
        ...
        return (EnumDoor)addEnum(decompiled[5], net.minecraft.src.EnumDoor.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumEnchantmentType addEnchantmentType(String s)
    {
        ...
        return (EnumEnchantmentType)addEnum(decompiled[6], net.minecraft.src.EnumEnchantmentType.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumMobType addMobType(String s)
    {
        ...
        return (EnumMobType)addEnum(decompiled[7], net.minecraft.src.EnumMobType.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumMovingObjectType addMovingObjectType(String s)
    {
        ...
        return (EnumMovingObjectType)addEnum(decompiled[8], net.minecraft.src.EnumMovingObjectType.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumSkyBlock addSkyBlock(String s, int i)
    {
        ...
        return (EnumSkyBlock)addEnum(decompiled[9], net.minecraft.src.EnumSkyBlock.class, s, new Class[] {
            Integer.TYPE
        }, new Object[] {
            Integer.valueOf(i)
        });
    ...
    public static EnumStatus addStatus(String s)
    {
        ...
        return (EnumStatus)addEnum(decompiled[10], net.minecraft.src.EnumStatus.class, s, new Class[0], new Object[0]);
    }
    ...
    public static EnumToolMaterial addToolMaterial(String s, int i, int j, float f, int k, int l)
    {
        ...
        return (EnumToolMaterial)addEnum(decompiled[11], net.minecraft.src.EnumToolMaterial.class, s, new Class[] {
    ...
    private static Object getConstructorAccessor(boolean flag, Class class1, Class aclass[])
        throws Exception
    {
        Class aclass1[] = null;
        if(flag)
    ...
    private static Enum makeEnum(boolean flag, Class class1, String s, int i, Class aclass[], Object aobj[])
        throws Exception
    {
        Object aobj1[] = null;
        if(flag)
    ...
    private static void setFailsafeFieldValue(Field field, Object obj, Object obj1)
        throws Exception
    {
    ...
    private static void blankField(Class class1, String s)
        throws Exception
    {
    ...
    private static void cleanEnumCache(Class class1)
        throws Exception
    {
    ...
    public static Enum addEnum(boolean flag, Class class1, String s, Class aclass[], Object aobj[])
    {
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if((field1.getModifiers() & c) != c || !field1.getType().getName().equals(s1))
            {
                continue;
            }
            field = field1;
        ...
        try
        {
            ...
            Enum enum = makeEnum(flag, class1, s, arraylist.size(), aclass, aobj);
            arraylist.add(enum);
