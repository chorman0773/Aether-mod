...
public class EnumHelperClient extends EnumHelper
{
    ...
    public static EnumJsonNodeType addJsonNodeType(String s)
    {
        if(!isSetup)
        {
            setup();
        }
        return (EnumJsonNodeType)addEnum(decompiled[0], net.minecraft.src.EnumJsonNodeType.class, s, new Class[0], new Object[0]);
    }
    ...
    static 
    {
        ctrs = (new Class[][] {
            new Class[] {
                net.minecraft.src.EnumJsonNodeType.class
            }, new Class[] {
